...
class Dart(tfds.core.GeneratorBasedBuilder):
  """TODO(dart): Short description of my dataset."""

  VERSION = tfds.core.Version('0.1.0')

  def _info(self):
    # TODO(dart): Specifies the tfds.core.DatasetInfo object
  ...
  def _split_generators(self, dl_manager):
    ...
    return [
        tfds.core.SplitGenerator(
            ...
            gen_kwargs={
                'json_file':
                    os.path.join(extracted_path, 'dart-v1.1.1-full-train.json')
            },
        ),
        tfds.core.SplitGenerator(
            ...
            gen_kwargs={
                'json_file':
                    os.path.join(extracted_path, 'dart-v1.1.1-full-dev.json')
            },
        ),
        tfds.core.SplitGenerator(
